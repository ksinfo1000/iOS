...
class KsRecordsViewController: UIViewController {
    ...
    lazy var thirdChildTabVC : UIViewController? = {
        let thirdChildTabVC = self.storyboard?.instantiateViewController(withIdentifier: "PhotoCategoryViewControllerIdWithCategory")
    ...
    override func viewDidLoad() {
        ...
        self.title = "КS Records"
        
        defaults.set(1, forKey: "section")
